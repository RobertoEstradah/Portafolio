document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    es: {
      ...
      "projects.lead": "Proyectos de investigación aplicada y desarrollo Full Stack donde combino física computacional, ingeniería de datos e IA para resolver problemas reales.",
    ...
    en: {
      ...
      "projects.lead": "Applied research and Full Stack development projects where I combine computational physics, data engineering and AI to solve real-world problems.",
    ...
    de: {
      ...
      "projects.lead": "Projekte aus angewandter Forschung und Full-Stack-Entwicklung, in denen ich Computerphysik, Data Engineering und KI kombiniere, um reale Probleme zu lösen.",
    ...
    fr: {
      ...
      "projects.lead": "Projets de recherche appliquée et de développement Full Stack où je combine physique computationnelle, ingénierie des données et IA pour résoudre des problèmes concrets.",
